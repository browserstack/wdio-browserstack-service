...
class _InsightsHandler {
    ...
    public setTestData (test: Frameworks.Test | ITestCaseHookParameter, uuid: string) {
        ...
        // screenshot branch when it finds no entry, so the CLI cucumber path has to seed it too
        // (SDK-4177) — legacy seeded it from beforeScenario, which the CLI branch skips.
